...
\question{Suppose $a < b$ and $b \leq c$.  Is it guaranteed that $a \leq c$?  Work with examples if it helps, and look for a counterexample.  One concrete counterexample would be enough.}{0.0in}

\question{Suppose $a < b$ and $b \leq c$.  Is it guaranteed that $a < c$?  Work with examples if it helps, and look for a counterexample.  One concrete counterexample would be enough.}{0.0in}

\question{Suppose $a \leq b$ and $b \leq c$.  Is it guaranteed that $a < c$?  Work with examples if it helps, and look for a counterexample.  One concrete counterexample would be enough.}{0.0in}

\question{Suppose $a > 12$.  Consider the inequality $-a > -12$.  Write down five numbers satisfying $a > 12$ and check whether or not they satisfy $-a > -12$.  Look for a counterexample.  If you find a counterexample, put a box around it.  If the result is OK, put a check mark.}{0.1in}
