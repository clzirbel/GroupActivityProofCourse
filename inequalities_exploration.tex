...
Writing $a \leq 7$ does not mean, ``I certify that $a$ really could equal 7.''  Instead, it means more like ``I certify that the value of $a$ can be at most 7'.''  Again, is it also true that $a \leq 7$?}{0.0in}
...
\question{Suppose $a < b$ and $b \leq c$.  Is it certain that $a < c$?  Work with examples if it helps, and look for a counterexample.}{0.0in}

\question{Suppose $a < b$ and $b \leq c$.  Is it certain that $a \leq c$?  Work with examples if it helps, and look for a counterexample.}{0.0in}
