...
\item Find two different ways to construct a real number $c$ satisfying $x < c$.
\elist
}{0.2in}

\prove{Given a real number $x$, describe a procedure that results in an integer $n$ with $n > x$.
...
\item Given an integer $k>1$, describe a procedure to find the smallest integer with $n^2 > k$.

\item Describe a procedure for finding the largest integer $n$ with $n^2 < 1777$.

\elist
}{0.2in}

\prove{Given a real number $a$, construct an integer $n$ with $a \leq n < a+1$.

\vspace{0.5in}
\noindent
What value does your procedure give when $x = 13.1$?  \hfill $x = 18$?  \hfill $x = -22.2$?
}{0.4in}
