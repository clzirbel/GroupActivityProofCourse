...
\groupwork{Step (b) in each of your proofs uses the definition of even or odd to write $m$ and $n$ in a more useful, more informative way.
How does this help your proof along?
Discuss with members of your group.}{0.75in}

\groupwork{Step (d) in each of your proofs also uses the definition.
How does this use of the definition differ from what happens in Step (b)?
Discuss with members of your group.}{0.75in}
...
\prove{Show that the square of an add number is odd.  That is, if $m$ is odd, then $m^2$ is odd.\label{oddsquared}}{1.5in}
