...
\vspace*{0.5in}
\noindent
Find specific values of $m$ and $n$ for which $m=2k$ and $n=2k$ for some integer $k$ does happen.

\vspace*{0.5in}
\noindent
Find specific values of $m$ and $n$ for which $m=2k$ and $n=2k$ for some integer $k$ does not happen.
