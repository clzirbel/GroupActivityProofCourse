...
\example{Find $[1,5] \cup (3,7)$.  Draw a diagram on a number line to illustrate.}{0.4in}

\example{Find $[1,5] \cap (3,7)$.  Draw a diagram on a number line to illustrate.}{0.4in}

\problem{Let $3\Z = \{ m \in \Z :$ there exists $j \in \Z$ such that $m = 3j\}$.
Let $5\Z = \{ m \in \Z :$ there exists $j \in \Z$ such that $m = 5j\}$, and similarly with other sets like $7\Z$ and $11\Z$.
...
\prove{Show that $2\Z \cap 7\Z \subseteq 14\Z$.  Use good form.  You do not need to prove any results about divisibility, simply use what you know is true.
...
\noindent
In both cases, \blank{0.7in}.  Thus, \blank{0.7in}.
...
\prove{Show that $14\Z \subseteq 2\Z \cap 7\Z$.  Use good form and make a general conclusion at the end.
