...
\example{Is $\vect{ \sqrt{3},\sqrt[3]{9},\sqrt[4]{-12} }$ a 3--dimensional vector? Explain.}{0.4in}

\example{Is $\vect{ 8,13.35321,\pi,-7 }$ a 3--dimensional vector? Explain.}{0.4in}

\example{Is $\vect{ 1,\pm 7,\heartsuit }$ a 3--dimensional vector? Explain.}{0.4in}

\example{Is $\vect{ 3 + 9 + 12 }$ a 3--dimensional vector? Explain.}{0.4in}

\example{Is $\vect{ \left[ \begin{array}{cc} 6 & 0 \\ 2 & 5 \end{array} \right], -4, 7 }$ a 3--dimensional vector?}{0.4in}

\example{Let $x$ be a real number.  Is $\vect{ \frac{14}{3},2-7x,\sqrt{16} }$ a 3--dimensional vector? Explain.}{0.4in}
...
This last part is very important.}{2in}
...
\example{Let $c = 3$ and $\vec{a} = \vect{7,-4,\sqrt{2}}$.  Calculate $c\vec{a}$, starting by writing $c\vec{a} = \ldots$.}{0.5in}

\example{Calculate $(2+\sqrt{3}) \vect{9,4,1}$.}{0.5in}
