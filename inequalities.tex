...
\vspace*{0.1in}
\noindent
Case 1.  Suppose that $a \in $ \blank{0.5in}.

\vspace*{0.3in}
\noindent
Case 2.  Suppose that $(-a) \in $ \blank{0.5in}.
}{0.0in}
...
\show{Show that $(-1) \notin \Rp$.
{\bf Hint:} Pretend for a minute that $(-1) \in \Rp$ and use \ref{positivereals}c.}{0.5in}

\definition{Less than}{\label{lessthan}Let $a$ and $b$ be real numbers.  
If $b+(-a)  \in \Rp$, we write that $a < b$ and say that $a$ is {\em less than } $b$.}
